...
const mysqlConnection = require("../../MS_AZURE/connection");
const db2connect = require("./db2Connection");

//above are all import statements

var peopleRoutes = require("../../MS_AZURE/routes/people");
var index1 = require("../../MS_AZURE/routes/index");
